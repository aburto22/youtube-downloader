...
new_song = {
  "title": 'Kyla La Grange, Kygo - Cut Your Teeth (Radio Edit)',
  "src": 'https://www.youtube.com/watch?v=344rPrzY2FM&list=RD344rPrzY2FM&start_radio=1&ab_channel=KylaLaGrangeVEVO'
}
